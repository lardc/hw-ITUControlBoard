...
#define REG_COEFF_CURRENT1_R1_K			13	// Пропорциональный коэффициент пересёта тока 1 на сопротивлении R1
...
#define REG_COEFF_CURRENT1_R2_K			17	// Пропорциональный коэффициент пересёта тока 1 на сопротивлении R2
...
#define REG_COEFF_CURRENT2_R1_K			25	// Пропорциональный коэффициент пересёта тока 2 на сопротивлении R1
...
#define REG_COEFF_CURRENT2_R2_K			29	// Пропорциональный коэффициент пересёта тока 2 на сопротивлении R2
...
#define REG_COEFF_CURRENT3_R1_K			37	// Пропорциональный коэффициент пересёта тока 3 на сопротивлении R1
...
#define REG_COEFF_CURRENT3_R2_K			41	// Пропорциональный коэффициент пересёта тока 3 на сопротивлении R2
...
#define REG_COEFF_CURRENT4_R1_K			49	// Пропорциональный коэффициент пересёта тока 4 на сопротивлении R1
...
#define REG_COEFF_CURRENT4_R2_K			53	// Пропорциональный коэффициент пересёта тока 4 на сопротивлении R2
...
#define REG_IGNORE_SPIKE				77	// Игнорировать игольчатый пробой
